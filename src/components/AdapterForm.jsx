...
export default function AdapterForm() {
  ...
  const onSubmit = (evento) => {
    ...
    const jsonToYaml = YAML.stringify(
    jsonObject,
    null,
    2
  );
      ...
      <form action='' onSubmit={onSubmit} className="formulario">
        <div className="row">
          <div className="col">
            ...
            <input type="text" id="inputId" className="form-control" placeholder="Ingrese ID" 
            onChange={(evento) => setId(evento.target.value)} />



            <label htmlFor="inputStepName" className="form-label"> StepName</label>
            <input type="text" id="inputStepName" className="form-control" placeholder="Ingrese stepName"
          ...
          <div className="col">
            ...
            <label htmlFor="inputDependencias" className="form-label"> Dependencias </label>
        ...
        <div className="col-12">
          ...
          <div className="d-grid gap-2 d-md-flex justify-content-md-end">
            <button className="btn btn-primary me-md-2" type="submit">Descargar</button>
